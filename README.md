...
**Core Principle**: *Student identities are never exposed.* Every student receives a persistent anonymous identity (e.g., "Anonymous Sparrow") used across all platform features. Only the authentication layer can link an anonymous identity to a real identity.
