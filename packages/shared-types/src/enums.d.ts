 ...
 */
export declare enum EmotionContext {
  POST = 'POST',
  CHAT = 'CHAT',
 ...
 */
export declare enum MeetingHostType {
  STUDENT = 'STUDENT',
  MENTOR = 'MENTOR',
}
/**
 ...
 */
export declare enum MeetingCategory {
 ...
 */
export declare enum WorkshopCategory {
 ...
 */
export declare enum MentorAvailabilityStatus {
  AVAILABLE = 'AVAILABLE',
  BUSY = 'BUSY',
  OFFLINE = 'OFFLINE',
}
 ...
 */
export declare enum WorkshopRegistrationStatus {
