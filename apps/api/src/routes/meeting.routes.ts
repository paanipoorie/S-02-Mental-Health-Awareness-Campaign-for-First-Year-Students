...
router.get('/meetings/upcoming/student', meetingController.getUpcomingMeetingsForStudent);

router.get('/meetings/upcoming/mentor', meetingController.getTodaysMeetingsForMentor);

router.get('/meetings/:id', validate(getMeetingParamsSchema), meetingController.getMeetingById);

router.post('/meetings/:id/rsvp', validate(rsvpMeetingParamsSchema), meetingController.rsvpMeeting);

router.delete('/meetings/:id', validate(getMeetingParamsSchema), meetingController.cancelMeeting);
...
router.get('/workshops', validate(getWorkshopsQuerySchema), meetingController.getWorkshops);

router.get('/workshops/upcoming/student', meetingController.getUpcomingWorkshopsForStudent);

router.get('/workshops/upcoming/mentor', meetingController.getTodaysWorkshopsForMentor);

router.get('/workshops/:id', validate(getWorkshopParamsSchema), meetingController.getWorkshopById);
