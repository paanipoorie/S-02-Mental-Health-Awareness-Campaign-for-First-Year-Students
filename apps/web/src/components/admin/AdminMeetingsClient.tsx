  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-heading-24 font-bold text-slate-900">Meeting Management</h1>
          <p className="text-copy-14 text-slate-500 mt-1">View and manage all platform meetings</p>
        </div>
      </div>
